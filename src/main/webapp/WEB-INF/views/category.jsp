                                    ...
                                    <div class="productInfo2">
                                        ...
                                        <j:choose>
                                            <j:when test="${product.quantityInStock != 0}">
                                                <p class="quantityInStock">Quantity in
                                                    stock: ${product.quantityInStock}</p>
                                        ...
                                        <input name="quantityInStock" class="quantityInStockValue"
                                               value="${product.quantityInStock}" hidden/>
                                    </div>
                                </div>
                            </div>
                        </li>
