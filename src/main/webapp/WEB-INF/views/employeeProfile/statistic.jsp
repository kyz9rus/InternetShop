     ...
     <div id="header">
      ...
      <div class="content row">
          ...
          <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 mainPanel" align="center">
              <div class="variant statistic">
                  <form method="post" action="/employeeProfile/toStatistic">
                      <select name="statistic">
                          <option>TOP-10 clients</option>
                          <option>TOP-10 products</option>
                          <option>Monthly/weekly revenue</option>
                      </select>
                      <button class="btn formButton">SHOW</button>
                  </form>
            </div>
          </div>
       </div>
