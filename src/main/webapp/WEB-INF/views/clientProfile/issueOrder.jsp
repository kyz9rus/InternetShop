                ...
                <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 mainPanel">
                    ...
                    <div class="variant issueOrderBlock">
                        <j:choose>
                            ...
                            <j:otherwise>
                                <p class="emptyProductsListLabel" style="display: none">You have not chosen anything
                                    yet.</p>
                                <p class="emptyProductsListLabel" style="display: none">Choose category above and do
                                                        ...
                                                        <div class="productInfo">
                                                            <div class="productInfo1">
                                                                ...
                                                                <p class="productWeight">
                                                                    Weight: ${product.key.weight}г.</p>
                                                                <p class="productSize">Volume: ${product.key.volume}</p>
                                                            </div>
                                                            <div class="productInfo2">
                                                                <p class="productPrice">Price: ${product.key.price}
                                                                    rubles.</p>
                                                                <p class="quantityInStock quantityInStock-${tagStatus.count}">
                                                                    Quantity in
                                                                    stock: ${product.key.quantityInStock}</p>
                                                                <input name="id" value="${product.key.id}" hidden/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="productOperations col-xs-2 col-sm-2 col-md-2 col-lg-1"
                                                         align="center">
                                                        <div class="form-group">
                                                            <img class="remove remove-${tagStatus.count}"
                                                                 src="<c:url value="/resources/images/cross.jpeg"/>"
                                                                 alt="X"/>
                                                            <img class="plus plus-${tagStatus.count}"
                                                                 src="<c:url value="/resources/images/plus.jpeg"/>"
                                                                 alt="+"/>
                                                            <img class="minus minus-${tagStatus.count}"
                                                                 src="<c:url value="/resources/images/minus.jpeg"/>"
                                                                 alt="-"/>
