                                  ...
                                  <div class="byCardBlock">
                                      <div class="headerCardBlock">
                                          ...
                                          <div class="orderInfoInCardBlock">
                                              <div class="form-group">
                                                  <label class="orderInfoPoint form-group">Order cost:</label>
                                                  <label class="orderInfoValue">${basket.summaryPrice} rubles</label><br>
                                              </div>
                                              <div class="form-group">
                                              ...
                                              <div class="priceOrderInfo">
                                                  ...
                                                  <label class="text-success totalPrice">${basket.summaryPrice} rubles</label>
                                              </div>
                                          </div>
                                          <div class="cardInfo">
                                              <div class="cardInfoContent">
                                                  ...
                                                  <div class="cvcCodeBlock">
                                                      <div class="form-group">
                                                          ...
                                                          <p>CVC/CVV is written on the back of the card</p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
