...
//@WebAppConfiguration
//@ContextConfiguration(classes = {WebConfig.class, HibernateConfig.class, MyWebAppInitializer.class, SecurityWebApplicationInitializer.class, ServletInitializer.class, WebSecurityConfig.class})
